...
import com.UDcode.RomenPride.entity.mob.Player;
...
import com.UDcode.RomenPride.level.TileCoordinate;
...
public class Game extends Canvas implements Runnable {
	...
	public static String title = "RomenPride";
	...
	public Game(){
		...
		key = new Keyboard();
		level =Level.spawn;
		TileCoordinate playerSpawn = new TileCoordinate(19,60);
